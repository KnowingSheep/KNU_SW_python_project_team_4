...
const icons = {
  차대차: L.icon({ iconUrl: "/static/svg/cvc.svg", iconSize: [32, 32] }),
  차량단독: L.icon({ iconUrl: "/static/svg/cs.svg", iconSize: [32, 32] }),
  차대사람: L.icon({ iconUrl: "/static/svg/cvm.svg", iconSize: [32, 32] })
};
